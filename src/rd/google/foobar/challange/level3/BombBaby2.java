 ...
 * function solution(M, F) where M and F are the number of Mach and Facula bombs
 ...
 * 
 * -- Java cases -- Input: Solution.solution('2', '1') Output: 1
 * 
 * Input: Solution.solution('4', '7') Output: 4
 * 
 * -- Python cases -- Input: solution.solution('4', '7') Output: 4
 * 
 * Input: solution.solution('2', '1') Output: 1
 */

public class BombBaby2 {
	...
	public static BigInteger func(BigInteger m, BigInteger f) {
		...
		while ((check = m.compareTo(f)) != 0) {
			if (check == -1) {
				...
				// m = m.subtract(f); 1 testcase fail
	...
	public static void main(String[] args) {
		String m1 = "2", f1 = "1";
		System.out.println(solution(m1, f1));

		String m2 = "4", f2 = "7";
		System.out.println(solution(m2, f2));
	}
}
