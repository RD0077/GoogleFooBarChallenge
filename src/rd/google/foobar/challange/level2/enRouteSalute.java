...
public class enRouteSalute {
	/*
	 * Commander Lambda loves efficiency and hates anything that wastes time. She's
	 * a busy lamb, after all! She generously rewards henchmen who identify sources
	 * of inefficiency and come up with ways to remove them. You've spotted one such
	 * source, and you think solving it will help you build the reputation you need
	 * to get promoted.
	 * 
	 ...
	 * ten seconds (Commander Lambda's salute is a bit, er, involved). You think
	 * that by removing the salute requirement, you could save several collective
	 * hours of employee time per day. But first, you need to show her how bad the
	 * problem really is.
	 * 
